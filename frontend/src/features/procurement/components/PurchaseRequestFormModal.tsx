  ...
  return (
    <Modal title={title} onClose={onClose}>
      ...
      <div className="mt-6 flex justify-end gap-2 border-t border-slate-800 pt-6">
        ...
        {formHeader.id && detailMode === 'request' && formHeader.status === 'T' && (canDelete || isOwnTempRequest) && <button type="button" onClick={() => deleteRequest(formHeader.id!)} className="cursor-pointer rounded-lg border-0 bg-rose-900/70 px-4 py-2 text-xs font-semibold text-rose-100 hover:bg-rose-800">삭제</button>}
